...
hps = {
    'learning_rate': 0.001,
    'update_after': 5, 'update_target_after': 10, 'batch_size': 32, 'use_negative_rewards': None}
plot_avg_vals(
    'scores', 5000, 10,
...
hps = {
    'learning_rate': 0.001,
    'update_after': 20, 'update_target_after': 30, 'batch_size': 32, 'use_negative_rewards': None}
plot_avg_vals(
    'scores', 5000, 10,
