...
hps = {
    'learning_rate': 0.01,
    'update_after': 5, 'update_target_after': 5, 'batch_size': 64, 'use_negative_rewards': False}
plot_avg_vals(
    'scores', 5000, 10,
...
hps = {
    'learning_rate': 0.001,
    'update_after': 5, 'update_target_after': 10, 'batch_size': 32, 'use_negative_rewards': False}
plot_avg_vals(
    'scores', 5000, 10,
...
hps = {
    'learning_rate': 0.001,
    'update_after': 1, 'update_target_after': 1, 'batch_size': 32, 'use_negative_rewards': False}
plot_avg_vals(
    'scores', 5000, 10,
