...
hps = {
    'learning_rate': 0.001,
    'update_after': 10, 'update_target_after': 20, 'batch_size': 16, 'use_negative_rewards': False}
plot_avg_vals(
    'scores', 5000, 10,
...
hps = {
    'learning_rate': 0.001,
    'update_after': 20, 'update_target_after': 30, 'batch_size': 16, 'use_negative_rewards': False}
plot_avg_vals(
    'scores', 5000, 10,
