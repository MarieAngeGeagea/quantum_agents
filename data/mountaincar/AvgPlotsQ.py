...
csv_files = [
    '/home/marieange/quantum_agents/data/mountaincar/Quantum_Case_1_Data.csv', 
    '/home/marieange/quantum_agents/data/mountaincar/Quantum_Case_2_Data.csv', 
    '/home/marieange/quantum_agents/data/mountaincar/Quantum_Case_3_Data.csv',
    '/home/marieange/quantum_agents/data/mountaincar/Quantum_Case_4_Data.csv', 
    '/home/marieange/quantum_agents/data/mountaincar/Quantum_Case_5_Data.csv', 
    '/home/marieange/quantum_agents/data/mountaincar/Quantum_Case_6_Data.csv'
]
...
for i, ax in enumerate(axes):
    ...
    ax.grid(True)
    ax.set_title(f'Units in each hidden layer: {depths[i]}')
